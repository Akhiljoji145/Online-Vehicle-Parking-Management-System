...
$SQL="SELECT CURRENT_TIME,CURRENT_DATE,vehicles.arr_time,vehicles.confirm,vehicles.date_arr FROM vehicles WHERE vehi_no='$vehi_no' AND vehicles.date_arr=CURRENT_DATE";
